...
require_once __DIR__ . '/device/functions/database.php';
require_once __DIR__ . '/device/functions/device_operations.php';
require_once __DIR__ . '/device/functions/validation.php';
