...
<div class="top_nav">
    <div class="nav_menu">
        ...
        <li class="nav-item" style="padding-left: 15px;">
          <a href="javascript:;" class="user-profile" id="logoutBtn" title="Logout">
            <i class="bi bi-box-arrow-right"></i>
          </a>
        </li>
        <!-- Backup Database Button -->
        <li class="nav-item" style="padding-left: 15px;">
          <a href="javascript:;" class="user-profile" id="backupBtn" title="Backup Database">
...
<style>
    ...
    .menu-btn--primary .menu-btn-chevron {
    ...
    .menu-btn--danger .menu-btn-chevron {
