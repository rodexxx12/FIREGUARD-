...
echo "<h3>Session:</h3>";
echo "Superadmin logged in: " . (isset($_SESSION['superadmin_id']) ? "✅ Yes" : "❌ No") . "<br>";
if (isset($_SESSION['superadmin_id'])) {
    echo "Superadmin ID: " . $_SESSION['superadmin_id'] . "<br>";
    echo "Superadmin username: " . ($_SESSION['superadmin_username'] ?? 'N/A') . "<br>";
}
