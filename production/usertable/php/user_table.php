...
<body class="nav-md">
    ...
    <div class="right_col" role="main">
        <div class="filter-overlay" id="userFilterOverlay" onclick="toggleUserFilterPanel()"></div>
        <div class="filter-panel" id="userFilterPanel">
            <div class="filter-panel-header">
                <h3><i class="fa fa-filter" style="margin-right: 8px;"></i> Filters</h3>
                <button class="btn btn-sm btn-outline-secondary" onclick="toggleUserFilterPanel()" title="Close Filters">
            ...
            <div class="filter-panel-body">
                ...
                <div class="filter-group d-flex gap-2">
                    <button type="button" class="btn btn-outline-danger btn-sm w-100" id="resetAllFilters">
                ...
                <div class="filter-group">
                    <small class="text-muted d-block"><span id="filterStatus"></span></small>
                </div>
            </div>
        </div>
        <div class="main-card">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
                                <a class="filter-toggle-btn" id="userFilterToggleBtn" title="Toggle Filters">
            ...
            window.addEventListener('load', function() {
                ...
                function initializeDataTable() {
                    ...
                    var table = jQuery('#usersTable').DataTable({
                        ...
                        order: [
                            [8, 'desc']
                        ], // Registration Date column (now index 8)
                        columnDefs: [{
                                orderable: false,
                                targets: [9]
                            }, // Actions column (now index 9)
                            {
                                className: "text-center",
                                targets: [5, 6, 7, 8, 9]
                            }, // Status, Devices, Buildings, Registration Date, Actions
                            {
                    ...
                    // Burger-style side filter panel (mirrors buildingtable)
                    var $filterPanel = jQuery('#userFilterPanel');
                    var $filterOverlay = jQuery('#userFilterOverlay');
                    var $filterToggleBtn = jQuery('#userFilterToggleBtn');

                    window.toggleUserFilterPanel = function() {
                    ...
                    // Initialize filter status on load
                    updateFilterStatus();
