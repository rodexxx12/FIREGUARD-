                    ...
                    <div class="confirmation-container">
                        ...
                        <div class="review-sections">
                            ...
                            <div class="review-section">
                                ...
                                <button type="button" class="btn-edit" onclick="window.location.href='registration.php?step=personal'">
                            ...
                            <div class="review-section">
                                ...
                                <button type="button" class="btn-edit" onclick="window.location.href='registration.php?step=location'">
                                    <i class="fas fa-edit"></i> Edit
                                </button>
                            </div>
                            ...
                            <div class="review-section">
                                ...
                                <button type="button" class="btn-edit" onclick="window.location.href='registration.php?step=device'">
                                    <i class="fas fa-edit"></i> Edit
                                </button>
                            </div>
                            ...
                            <div class="review-section">
                                ...
                                <button type="button" class="btn-edit" onclick="window.location.href='registration.php?step=credentials'">
                                    <i class="fas fa-edit"></i> Edit
                                </button>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="" id="confirm-form">
                            ...
                            <div style="background: #fff3cd; border-left: 3px solid #ffc107; padding: 10px 12px; margin: 12px 0; border-radius: 4px;">
                                <strong style="font-size: 0.95em;"><i class="fas fa-exclamation-triangle" style="color: #ffc107;"></i> Important:</strong>
                                <p style="margin: 5px 0 0 0; font-size: 0.9em; line-height: 1.3;">
